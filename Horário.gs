...
function executarImportacoesReal_(props, runId, TTL_MS) {
  ...
  Logger.log("⏱️ Agendando verificação de estoque para executar em 1 minuto...");
  ScriptApp.newTrigger("verificarEsincronizar")
    .timeBased()
    .after(1 * 60 * 1000)
    .create();
  Logger.log("✅ Gatilho de verificação de estoque criado.");
}
